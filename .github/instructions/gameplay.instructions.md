...
- Conserver le runtime Pygame existant tant qu'aucune migration ciblée n'est demandée.
- Pour un nouveau composant de gameplay temps réel ou une migration locale explicitement demandée, privilégier Arcade.
- Ne jamais transformer tout le gameplay Pygame en Arcade sans demande explicite sur le périmètre complet.
